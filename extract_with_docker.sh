...
echo "Staring dockers"
export OSMNX_DOCKER_FILENAME=${continet}_${city}_${timestampe}
export BASE_OSMNX=$(pwd)
docker-compose up -d
sleep 20
...
curl curl -g 'http://localhost:12345/api/interpreter?data=[out:json];area[name="Monte Carlo"];out;'
